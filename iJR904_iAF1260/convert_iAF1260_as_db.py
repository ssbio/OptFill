...
input1=open('iAF1260_as_db.txt','r')

#these are the output file names, 'w' denotes write operation
output1=open('mets_iAF1260.txt','w')
output2=open('rxntype_iAF1260.txt','w')
output3=open('Sij_iAF1260.txt','w')
output4=open('rxns_iAF1260.txt','w')
output5=open('ex_rxns_iAF1260.txt','w')
output6=open('irrev_rxns_f_iAF1260.txt','w')
output9=open('irrev_rxns_b_iAF1260.txt','w')
output7=open('rev_rxns_no_ex_iAF1260.txt','w')
output8=open('reg_rxns_iAF1260.txt','w')
