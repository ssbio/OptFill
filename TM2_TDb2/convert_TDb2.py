...
input1=open('TDb2.txt','r')

#these are the output file names, 'w' denotes write operation
output1=open('mets_db_2.txt','w')
output2=open('rxntype_db_2.txt','w')
output3=open('Sij_db_2.txt','w')
output4=open('rxns_db_2.txt','w')
output5=open('ex_rxns_db_2.txt','w')
output6=open('irrev_rxns_f_db_2.txt','w')
output9=open('irrev_rxns_b_db_2.txt','w')
output7=open('rev_rxns_no_ex_db_2.txt','w')
output8=open('reg_rxns_db_2.txt','w')
