...
$include "biomass_precursors_3.txt"

	j						set of all reactions
$include "all_rxns_3.txt"

	j_db(j)					set of all reactions in the database
$include "rxns_db_3.txt"
...
FILE RESULT /OptFill_result_TM3_TDb3.txt/;
PUT RESULT;
RESULT.pw=1000;
